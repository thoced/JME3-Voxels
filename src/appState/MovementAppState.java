...
public class MovementAppState extends AbstractAppState implements RawInputListener{
  ...
  private Vector3f offsetSquat = new Vector3f(0,1.5f,0);
  private Vector3f offsetStanding = new Vector3f(0,2f,0);
  ...
  WaterFilter water;
    ...
    public void initialize(AppStateManager stateManager, Application app)
    {
        ...
        cam = app.getCamera();
        // parametrage caméra
        cam.setFrustumPerspective(45f, (float) cam.getWidth() / cam.getHeight(), 0.05f, 350f);
        
        bulletAppState = stateManager.getState(BulletAppState.class);
        
        // physique player
        player =  new BetterCharacterControl(0.5f,2f,0.5f);
        player.setJumpForce(new Vector3f(0,4,0));
        player.setGravity(new Vector3f(0,-1,0));
        
        playerNode = new Node();
        playerNode.setLocalTranslation(150, 64f,128);
